        ...
        <tr>
          <td>
            ...
            <form method="post" action="editar.php?nombre=$nombre">
              <input type="submit" name='editarArtista' value = "Editar"/></form>
            <form method="post" action="eliminar.php?nombre=$nombre">
              <input type="submit" name='eliminarArtista' value = "Eliminar"/></form>
        </td>
...
$contenido.=<<<EOS
  ...
  <input type="submit" name='añadirArtista' value = "Añadir"/></form>
